...
int doCommand(char *commandline, int *ret1, int *ret2, int *ret3) {
  ...
  if (strcmp(command, "set_zoom_value") == 0) {
    if ((arg1 == NULL) || (intarg1 < 0) || (intarg1 > 16385)) {
      return 41;
    }
  ...
  if (strcmp(command, "set_pantilt_absolute_position") == 0) {
    ...
    if ((arg3 == NULL) || (intarg3 < -1440) || (intarg3 > 1440)) {
      return 43;
    }
    if ((arg4 == NULL) || (intarg4 < -360) || (intarg4 > 360)) {
      return 44;
    }
  ...
  if (strcmp(command, "get_pantilt_position") == 0) {
    ...
    if (VISCA_get_pantilt_position(&iface, &camera, &tmp1, &tmp2)
        != VISCA_SUCCESS){
      return 46;
    }
    *ret1 = tmp1;
